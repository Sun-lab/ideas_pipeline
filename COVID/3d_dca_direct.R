# compared to 1d, this version considers more genes
...
fig.name  = sprintf("figures/3d_dca_direct_pval_hist_%s.pdf", 
                    grp)
file.name = sprintf("res/3d_dca_direct_pvals_%s.tsv", 
                    grp)
