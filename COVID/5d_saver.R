...
# ========================================================================
# this code is based on 1d_dca_direct.R to use saver for denoising
# ========================================================================
# take arguments
# ========================================================================
...
for(fit_method in c("saver_direct")){
  for(d_metric in c("Was", "JSD")){
    ...
    dist1 = ideas_dist(count_input, meta2kp, meta_ind, 
...
fig.name  = sprintf("figures/5d_saver_direct_pval_hist_%s.pdf", 
                    grp)
file.name = sprintf("res/5d_saver_direct_pvals_%s.tsv", 
                    grp)
