...
R CMD BATCH --no-save --no-restore '--args ncase=13 nctrl=10 ncell=1080 r_mean=1.2 r_var=1.5' step3_illustration.R step3_illustration_Rout/step3_illustration_13_10_1080_1.2_1.5.Rout &
...
R CMD BATCH --no-save --no-restore '--args ncase=10 nctrl=10 ncell=360 r_mean=1.2 r_var=1.5' step3_illustration.R step3_illustration_Rout/step3_illustration_10_10_360_1.2_1.5.Rout &

R CMD BATCH --no-save --no-restore '--args ncase=10 nctrl=10 ncell=1080 r_mean=1.2 r_var=1.5' step3_illustration.R step3_illustration_Rout/step3_illustration_10_10_1080_1.2_1.5.Rout &
...
R CMD BATCH --no-save --no-restore '--args ncase=20 nctrl=20 ncell=1080 r_mean=1.2 r_var=1.5' step3_illustration.R step3_illustration_Rout/step3_illustration_20_20_1080_1.2_1.5.Rout &
